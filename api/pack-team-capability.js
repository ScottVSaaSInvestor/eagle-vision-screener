...
// Bundled function: pack-team-capability
let _netlifyExports = {};
"use strict";
...
// netlify/functions/pack-team-capability.ts
var pack_team_capability_exports = {};
__export(pack_team_capability_exports, {
  handler: () => handler
});
_netlifyExports = __toCommonJS(pack_team_capability_exports);
...
module.exports = async function vercelHandler(req, res) {
  if (!_netlifyHandler) {
    res.status(500).json({ error: 'Handler not found in bundle', bundle: 'pack-team-capability' });
    return;
  }
